...
interface SuperLongArrowProps extends SVGProps<SVGSVGElement> {
  color?: string | undefined
}

export const Trash: FC<SuperLongArrowProps> = ({ color, ...props }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill={color} {...props}>
